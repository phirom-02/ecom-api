...
public class ApiResponseHandler {
    ...
    public static <T> ResponseEntity<ApiResponse<T>> success(T data) {
        return new ResponseEntity<>(new ApiResponse<>(data, HttpStatus.OK.getReasonPhrase()), HttpStatus.OK);
    }
    ...
    public static <T> ResponseEntity<ApiResponse<T>> created(T data) {
        return new ResponseEntity<>(new ApiResponse<>(data, HttpStatus.CREATED.getReasonPhrase()), HttpStatus.CREATED);
    }
